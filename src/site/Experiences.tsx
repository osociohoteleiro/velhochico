    ...
    <section id="experiencias" className="py-20">
      <div className="mx-auto max-w-7xl px-5">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll(-1)}
            className="absolute left-2 top-[6.5rem] z-10 grid h-10 w-10 -translate-y-1/2 place-items-center rounded-full bg-white text-brand shadow-lg transition hover:bg-brand hover:text-white"
            aria-label="Anterior"
          >
          ...
          <button
            onClick={() => scroll(1)}
            className="absolute right-2 top-[6.5rem] z-10 grid h-10 w-10 -translate-y-1/2 place-items-center rounded-full bg-white text-brand shadow-lg transition hover:bg-brand hover:text-white"
            aria-label="Próximo"
          >
